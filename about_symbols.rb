...
class AboutSymbols < Neo::Koan
  ...
  def test_method_names_become_symbols  # Ruby method names become symbols! Ah! Maybe this is why you use the File::Method notation.
  ...
  def test_to_s_is_called_on_interpolated_symbols
    ...
    assert_equal "It is raining #{:cats.to_s} and dogs.", string
  end
